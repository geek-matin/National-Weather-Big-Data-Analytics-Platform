      ...
      <div className="bg-[#0b0f17] border border-[#2d3b55] w-full max-w-2xl p-5 shadow-2xl relative tactical-box text-zinc-100">
        ...
        <div className="flex items-center justify-between border-b border-[#1c2538] pb-3 mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold tracking-wider uppercase text-zinc-100">
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-[#111724] border border-[#1e2a40] space-y-2 text-xs">
              <div className="flex items-center justify-between border-b border-[#1c2538] pb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.2 bg-zinc-900 border border-zinc-700 text-amber-400 font-bold text-[11px]">
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 bg-red-950/70 hover:bg-red-900 border border-red-500/70 text-red-300 uppercase tracking-wider text-xs transition-all disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={isProcessing}
                className="flex items-center gap-1.5 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-black font-bold uppercase tracking-wider text-xs transition-all disabled:opacity-50 shadow-tactical-glow-green"
              >
