      ...
      <div className="bg-[#0b0f17] border border-[#2d3b55] w-full max-w-4xl p-4 shadow-2xl relative tactical-box text-zinc-100 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between border-b border-[#1c2538] pb-3 mb-3">
          <div className="flex items-center gap-2">
            ...
            {event?.category && (
              <span className="px-1.5 py-0.2 bg-zinc-900 border border-zinc-700 text-[10px] text-cyan-300 uppercase font-bold">
                {event.category}
              </span>
            )}
          </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 text-[10px] text-zinc-400 pt-1">
              ...
              {event.source_url && (
                <a
                  ...
                  className="flex items-center gap-1.5 px-3 py-1 bg-cyan-950/80 hover:bg-cyan-900 border border-cyan-500 text-cyan-300 font-bold uppercase tracking-wider transition-all hover:shadow-tactical-glow-cyan"
                >
