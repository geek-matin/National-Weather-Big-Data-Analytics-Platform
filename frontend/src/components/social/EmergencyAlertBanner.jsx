    ...
    <div className="border-b border-red-800 bg-[#160a0e] px-4 py-2 text-xs font-mono">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
        <div className="flex items-center gap-2.5 flex-1 overflow-x-auto">
          <div className="flex items-center gap-1.5 px-2 py-0.5 bg-red-600 text-black font-bold tracking-wider uppercase animate-pulse shrink-0">
          ...
          <div className="flex items-center gap-4 text-red-300 tracking-wide overflow-x-auto whitespace-nowrap">
            {alerts.map((alert) => (
              <div key={alert.id} className="flex items-center gap-2 border-r border-red-900/60 pr-4">
                ...
                <span className="px-1.5 py-0.5 bg-red-950 border border-red-700/80 text-[10px] text-red-400 font-bold">
                  {alert.event_count || 1} REPORTS
                </span>
                {onDismiss && (
                  <button
        ...
        <div className="text-[11px] text-red-400 tracking-widest hidden lg:block font-mono">
