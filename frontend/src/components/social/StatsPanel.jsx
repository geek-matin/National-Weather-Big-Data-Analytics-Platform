            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={categoryStats} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                ...
                <XAxis
                  ...
                  stroke="#525e75"
                  fontSize={10}
                  tickFormatter={(val) => val ? val.slice(0, 5).toUpperCase() : ''}
                />
                <YAxis stroke="#525e75" fontSize={10} />
          ...
          {timelineStats && timelineStats.length > 0 ? (
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={timelineStats} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                ...
                <CartesianGrid strokeDasharray="2 2" stroke="#161f30" vertical={false} />
                <XAxis dataKey="time_label" stroke="#525e75" fontSize={10} />
                <YAxis stroke="#525e75" fontSize={10} />
                <Tooltip content={<CustomTooltip />} />
            ...
            regionStats.map((reg, idx) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <span className="px-1.5 py-0.5 bg-zinc-800 border border-zinc-700 text-cyan-300 font-bold text-[10px]">
                    {reg.count}
                  </span>
                </div>
              </div>
