    ...
    <div className="flex flex-col h-full bg-[#090d14] border border-[#1c2538] tactical-box">
      ...
      <div className="border-b border-[#1c2538] px-3 py-2 flex items-center justify-between bg-[#0b1019]">
        ...
        <div className="flex items-center gap-1.5 text-[10px] text-zinc-400">
          <span className="px-1.5 py-0.5 bg-zinc-800 border border-zinc-700 font-mono text-cyan-300">
            ...
            return (
              <div
                ...
                className={`p-2.5 border transition-all cursor-pointer select-none text-xs font-mono ${
                  isSelected
                    ? 'bg-[#101726] border-cyan-500 shadow-sm'
              ...
              >
                  ...
                  >
                    {isVideo ? (
                      <>
                        ...
                        <span className="absolute top-1.5 right-1.5 px-1.5 py-0.5 bg-black/90 border border-cyan-500 text-[9px] text-cyan-300 font-bold uppercase tracking-wider flex items-center gap-1">
                      ...
                      <>
                        <img
                          ...
                          loading="lazy"
                        />
                        <span className="absolute top-1.5 right-1.5 px-1.5 py-0.5 bg-black/90 border border-emerald-500 text-[9px] text-emerald-300 font-bold uppercase tracking-wider flex items-center gap-1">
                          <ImageIcon className="w-2.5 h-2.5" />
                          <span>ACTUAL PHOTO</span>
                        </span>
                      </>
                    )}
                    <span className="absolute bottom-1.5 left-1.5 px-1.5 py-0.5 bg-black/90 text-[9px] text-zinc-300 border border-zinc-700 font-mono">
                ...
                <div className="flex items-center justify-between text-[10px] text-zinc-500 pt-1.5 border-t border-[#182133]">
                  <div className="flex items-center gap-2">
                    <span className="px-1 py-0.5 bg-zinc-900 border border-zinc-800 text-zinc-400">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {ev.is_verified ? (
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          if (onOpenModerationWithEvent) onOpenModerationWithEvent(ev);
                        }}
